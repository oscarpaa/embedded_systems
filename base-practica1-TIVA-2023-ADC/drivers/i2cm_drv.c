...
//    }
    ...
    if (!xQueueReceiveFromISR(psInst->pCommands,(void *)pCommand,&xHigherPriorityTaskWoken))
    {
        return;
    }
         ...
         uint_fast8_t ui8TxDMA, uint_fast8_t ui8RxDMA, uint32_t ui32Clock)
{
    ...
    psInst->pCommands = xQueueCreate(NUM_I2CM_COMMANDS,sizeof(tI2CMCommand));
...
//    }
    ...
    xQueueSend(psInst->pCommands, (void *)&Command, portMAX_DELAY);
...
I2CMTransferResume(tI2CMInstance *psInst, uint8_t *pui8Data)
{
    ...
    if(psInst->ui8State == STATE_WRITE_PAUSE)
    {
        psInst->trans_actual.pui8WriteData = pui8Data;
    }
    else
    {
        psInst->trans_actual.pui8ReadData = pui8Data;
    }
